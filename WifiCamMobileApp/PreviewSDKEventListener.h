...
protected:
  ...
  PreviewSDKEventListener(StartViewController *startController);
...
public:
  ConnectionListener(StartViewController *startController) : PreviewSDKEventListener(startController) {}
};
...
private:
  void eventNotify(ICatchEvent *icatchEvt) {
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:nil
                                                     message:NSLocalizedString(@"CARD_FULL_RECORDING", nil)
                                                    delegate:nil
